////////////////////////////////
// Author: Bora DAN â€” http://codecanyon.net/user/bqra
// 18 August 2013
...
$(function () {    
    (function ($) {
        $.fn.jalendar = function (options) {
            ...
            dayNames['TR'] = new Array('Pzt', 'Sal', 'Ã‡ar', 'Per', 'Cum', 'Cmt', 'Pzr');
            dayNames['ES'] = new Array('Lun', 'Mar', 'MiÃ©', 'Jue', 'Vie', 'SÃ¥b', 'Dom');
            monthNames['EN'] = new Array('January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'); 
            monthNames['TR'] = new Array('Ocak', 'Åžubat', 'Mart', 'Nisan', 'MayÄ±s', 'Haziran', 'Temmuz', 'AÄŸustos', 'EylÃ¼l', 'Ekim', 'KasÄ±m', 'AralÄ±k'); 
            ...
            lAllDay['EN'] = 'All Day';
            lAllDay['TR'] = 'TÃ¼m GÃ¼n';
            lAllDay['ES'] = 'Todo El DÃ­a';
            lTotalEvents['EN'] = 'Total Events in This Month: ';
            lTotalEvents['TR'] = 'Bu Ayki Etkinlik SayÄ±sÄ±: ';
